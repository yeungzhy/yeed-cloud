...
public class FastJson2Config implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        provider.register(LocalDate.class, new ObjectWriter<LocalDate>() {
            final DateTimeFormatter df = DateTimeFormatter.ofPattern(DATE_PATTERN);
            @Override
            public void write(com.alibaba.fastjson2.JSONWriter jsonWriter, Object object, Object fieldName, Type fieldType, long features) {
                if (object == null) {
                    jsonWriter.writeNull();
        ...
        provider.register(LocalTime.class, new ObjectWriter<LocalTime>() {
            final DateTimeFormatter tf = DateTimeFormatter.ofPattern(TIME_PATTERN);
            @Override
            public void write(com.alibaba.fastjson2.JSONWriter jsonWriter, Object object, Object fieldName, Type fieldType, long features) {
                if (object == null) {
                    jsonWriter.writeNull();
        ...
        provider.register(Date.class, new ObjectWriter<Date>() {
            final java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat(DATE_TIME_PATTERN);
            @Override
            public void write(com.alibaba.fastjson2.JSONWriter jsonWriter, Object object, Object fieldName, Type fieldType, long features) {
                if (object == null) {
                    jsonWriter.writeNull();
