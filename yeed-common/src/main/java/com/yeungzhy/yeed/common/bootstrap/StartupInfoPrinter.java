package com.yeungzhy.yeed.common.bootstrap;
 ...
 * <h3>使用方式</h3>
 * <ol>
 *   <li>由 {@code StartupInfoPrinterConfig} 通过 {@code @Bean} 注册，该配置类由
 *       {@code AutoConfiguration.imports} 自动加载，下游模块引入 yeed-common 即生效，
 *       无需额外配置。</li>
