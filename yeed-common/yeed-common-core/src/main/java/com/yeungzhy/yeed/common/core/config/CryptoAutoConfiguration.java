 ...
 *
 * <p> CryptoProperties / CryptoPropertiesValidator / BlindIndexProvider 工具类均定义在 common-core，
 * Bean 注册也归 common-core 负责，保持「定义与注册在同一模块」
 * 业务侧盲索引 Bean（idCard / phone / email 等数据库场景专用）由 common-data 的
